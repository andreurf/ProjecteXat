...
public class ComponentAjustar extends MouseAdapter{
    ...
    public ComponentAjustar() {
        this(new Insets(5, 5, 5, 5), new Dimension(1, 1));
    }
    
    public ComponentAjustar(Component... components) {
        this(new Insets(5, 5, 5, 5), new Dimension(1, 1), components);
    }
    
    public ComponentAjustar(Insets dragInsets, Component... components) {
        this(dragInsets, new Dimension(1, 1), components);
    }
    
    public ComponentAjustar(Insets dragInsets, Dimension snapSize, Component... components) {
